...
function run_optimizer_and_plot(leader_vehicle, time_offset, start_position)
    ...
    % Costruzione nodi (il nodo iniziale usa start_position e time_offset)
    ...
    % Stato iniziale: il leader parte da start_position, i follower dietro
    ...
    T_abs = t_sim;  % t_sim include già l'offset
