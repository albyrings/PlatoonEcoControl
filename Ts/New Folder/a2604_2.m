...
function run_optimizer_and_plot(leader_vehicle, time_offset)
    ...
    delta_func = @(t) -50000 * (b1 + b2*(sin((1/b3)*t+b4) + 0.25*rand));
    ...
    check_velocity_triggers(T_abs, x_sim);
end
...
function check_velocity_triggers(t_abs, x_sim)
    ...
    for v = 1:n_vehicles
        ...
        % Calcola lo stato del trigger con ritardo iniziale incorporato
        trigger_state = velocity_trigger(t_sim, diff_v, v_opt);
