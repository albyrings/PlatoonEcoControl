...
function dx = system_dynamics_new_platoon(t, x, n_vehicles, m, delta_func, ...
    ...
    for i = 1:n_vehicles
        ...
        if i == leader_vehicle
            ...
            if abs(e_int_speed) < max_integral_speed || ...
               (e_int_speed >= max_integral_speed && vel_err < 0) || ...
               (e_int_speed <= -max_integral_speed && vel_err > 0)
            ...
            if i > 1
                ...
                % Nota: il segno è diverso rispetto alla versione precedente
            ...
            % Integrale con anti-windup
            if abs(e_int_dist(i)) < max_integral_dist || ...
               (e_int_dist(i) >= max_integral_dist && dist_err < 0) || ...
               (e_int_dist(i) <= -max_integral_dist && dist_err > 0)
